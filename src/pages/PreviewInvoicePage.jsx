    ...
    `}</style>
      ...
      <div style={{
        ...
        >
          ...
          {/* TABLEAU ARTICLES - Le tbody s'adapte automatiquement */}
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            <table style={{ 
              ...
              <thead style={{ flexShrink: 0 }}>
                <tr style={{ background: '#f5f5f5', display: 'table', width: '100%', tableLayout: 'fixed' }}>
                  <th style={{ 
                    border: '1px solid #000', 
                    padding: '2mm', 
                    textAlign: 'left',
          ...
          {/* MONTANT EN LETTRES + NOTES + SIGNATURES - Toujours en bas */}
